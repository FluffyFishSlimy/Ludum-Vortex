...
var TextBitmap = function( config ) {
	...
	if (config.shader=='msdf')
	{
		var material = this.material = new THREE.ShaderMaterial({
			uniforms: THREE.UniformsUtils.clone( MSDFShader.uniforms ),
			fragmentShader: MSDFShader.fragmentShader,
			vertexShader: MSDFShader.vertexShader,
